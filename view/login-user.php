...
<div class="section-header">
       ...
       <img src="../assets/img/dois-gatos.png" class="img-fluid rounded-4" alt="">
          ...
          <div class="col-lg-8">
            <form action="../controler/processar_login.php" method="post" role="form" class="php-email-form">
             <br><br><br>
              ...
              <br><br>
              <div class="text-center"> <a href="cad-user.php">Não possui cadastro?</a></div>
            </form>
